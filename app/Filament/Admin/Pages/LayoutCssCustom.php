...
class LayoutCssCustom extends Page implements HasForms
{
    ...
    protected static ?string $navigationLabel = 'Customização Layout e Pixel';

    protected static ?string $modelLabel = 'Customização Layout e Pixel';

    protected static ?string $title = 'Customização Layout e Pixel';

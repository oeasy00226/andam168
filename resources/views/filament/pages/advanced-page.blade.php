<x-filament-panels::page>
    ...
    <div class="w-full p-4 bg-gray-500 shadow-lg" style="background-color: #51515163; border-radius: 20px; border: 5px solid; animation: border-color-animation 4s infinite;">
        <h2 class="mb-5 text-3xl">Prime Connect </h2>
        <p>Velocidade e Estabilidade inagualável!
        </p>
        <br>
        <div class="flex justify-between w-full gap-4">
            <div class="flex flex-col gap-4 w-full justify-between">
                <button wire:click="loadProvider" style="border-radius: 10px" class="bg-primary-600 px-3 py-2 w-full text-center">
                    <div wire:loading wire:target="loadProvider">Carregando Provedores</div>
                    <div wire:loading.remove wire:target="loadProvider">Carregar Provedores</div>
                </button>
            </div>
            <button wire:click="loadGames" style="border-radius: 10px; overflow: hidden; position: relative; background-color: #7f3cb9" class="bg-primary-500 px-3 py-2 w-full">
                <div style="flex flex-col gap-4 w-full justify-between; color: #ffffff;">
                    <div wire:loading wire:target="loadGames">
                    ...
                    <div wire:loading.remove wire:target="loadGames">
                        Carregar Jogos
                    </div>
                </div>
            </button>
